  ...
  return (
    ...
    >
      ...
      <IconButton
        title="Github"
        className="text-5xl"
        onClick={() => link(Constants.github, '_blank')}
      >
      ...
      <IconButton
        title="LinkedIn"
        className="text-3xl"
        onClick={() => link(Constants.linkedIn, '_blank')}
      >
        <svg width="1em" height="1em" viewBox="0 0 24 24" className="fill-current">
      ...
      <IconButton title="Resume" onClick={() => link(Constants.resume, '_blank')}>
        <DocumentTextIcon />
      </IconButton>

      <IconButton title="Email" onClick={() => link(`mailto:${Constants.email}`, '_blank')}>
        <EnvelopeIcon />
      </IconButton>
    </MagicMenu>
  )
